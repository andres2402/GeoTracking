                     ...
                     <div class="content-section py-3">
                        <div class="row">
                           ...
                           <div class="col-6 text-left">
                              <p class="m-0">{{$customer->user->name}} {{$customer->user->last_name}}</p>
                           </div>
                        </div>
                        <hr class="my-1">
                        <div class="row">
                           ...
                           <div class="col-6 text-left">
                              <p class="m-0">{{$customer->user->phone}}</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col">
                     ...
                     <div class="content-section py-3">
                        <div class="row">
                           ...
                           <div class="col-6 text-left">
                              <p class="m-0">{{$subscription->name}}</p>
                           </div>
                        </div>
                        <hr class="my-1">
                        <div class="row">
                           ...
                           <div class="col-6 text-left">
                              <p class="m-0">{{$subscription->description}}</p>
                           </div>
                        </div>
                        <hr class="my-1">
                        <div class="row">
                           ...
                           <div class="col-6 text-left">
                              <p class="m-0">${{number_format($subscription->price, 0, ',', '.')}}</p>
                           </div>
                        </div>
                        <hr class="my-1">
                        <div class="row">
                           ...
                           <div class="col-6 text-left">
                              <p class="m-0">{{$infoRequest['quantity']}}</p>
                           </div>
                        </div>
                        <hr class="my-1">
                        <div class="row">
                           ...
                           <div class="col-6 text-left">
                              <p class="m-0">${{number_format($subscription->price * $infoRequest['quantity'], 0, ',', '.')}}</p>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col">
                     <div class="content-section">
                        <form role="form" id="idFormPayu" action="{{ env('PAYU_URL') }}" method="POST" autocomplete="off">
                           <input name="merchantId" type="hidden" value="{{$response['merchantId']}}">
                           <input name="accountId" type="hidden" value="{{$response['accountId']}}">
                           <input name="description" type="hidden" value="{{$response['description']}}">
                           <input name="referenceCode" type="hidden" value="{{$response['referenceCode']}}">
                           <input name="amount" type="hidden" value="{{$response['amount']}}">
                           <input name="tax" type="hidden" value="0">
                           <input name="taxReturnBase" type="hidden" value="0">
                           <input name="currency" type="hidden" value="COP">
                           <input name="test" type="hidden"  value="1">
                           <input name="signature" type="hidden" value="{{$response['signature']}}">
                           <input type="hidden" name="extra1" value="{{$response['extra1']}}">
                           <input name="buyerEmail" type="hidden" value="{{$response['buyerEmail']}}">
                           <input name="responseUrl" type="hidden" value="{{$response['responseUrl']}}">
                           <input name="confirmationUrl" type="hidden" value="{{$response['confirmationUrl']}}">
                           <button type="submit" class="btn btn-block">Ir a PayU</button>
                        </form>
                     </div>
                  </div>
               </div>
