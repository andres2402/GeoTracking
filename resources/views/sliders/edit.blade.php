		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h5 class="card-title">Editar Slider: {{$data['slider']->name}} </h5>
				</div>
				<div class="card-body">
					@include('layouts.alerts')
					<form action="{{route('sliders.update', $data['slider'])}}" method="POST" enctype="multipart/form-data">
						@method('PATCH')
						@csrf
						...
						<div class="row">
							<div class="form-group col-md-6 col-sm-12">
								...
								<input type="text" name="name" id="input-name" value="{{$data['slider']->name}}" class="form-control formclass" required>
							</div>
								...
								<div class="form-group col-md-6 col-sm-12">
									<div class="form-check-radio form-check-inline">
										<label class="form-check-label">
											<input class="form-check-input" type="radio" name="active" value="1" {{ $data['slider']->active==
											1 ?
											'checked': '' }}>
											Sí
									...
									<div class="form-check-radio form-check-inline">
										<label class="form-check-label">
											<input class="form-check-input" type="radio" name="active" value="0" {{ $data['slider']->active==
											1 ? '':
											'checked' }}>
											No
											<span class="form-check-sign"></span>
