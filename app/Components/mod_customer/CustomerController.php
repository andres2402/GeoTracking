...
use App\Components\mod_customer\Customer;
...
class CustomerController extends Controller
{
    ...
    public function index(Customer $customer)
    {
        ...
        return view('mod_customer.views.html.index', compact('customers'));
    }
    ...
    public function show($id)
    {
        ...
        return view('mod_customer.views.html.show', compact('customer'));
    }
    ...
    public function edit($id)
    {
        $customer = $this->showCustomer($id);
        $customer = $customer['data'];
        return view('mod_customer.views.html.edit', compact('customer'));
    }
